...
export class PostureAnalyzer {
  ...
  analyzePose(landmarks) {
    // landmarks expected to be an array of 33 MediaPipe pose landmarks (normalized coords)
