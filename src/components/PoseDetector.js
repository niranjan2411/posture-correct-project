...
export default function PoseDetector({ selectedPosture, isActive, onSessionComplete }) {
      ...
      try {
        ...
        pose.onResults((results) => {
          ...
          if (results.poseLandmarks) {
            ...
            // Analyze posture if session is active
        ...
        setError('Failed to initialize camera. Please allow camera access and refresh.')
        setIsLoading(false)
      }
    }
  ...
  // Update analyzer when posture type changes
  useEffect(() => {
    if (selectedPosture) {
          ...
          <div className="mt-4 grid grid-cols-3 gap-4">
            ...
            <div className="p-3 bg-orange-50 rounded-lg text-center">
              <div className="text-2xl font-bold text-orange-600">
                {sessionStats.poorPostureTime}s
              </div>
